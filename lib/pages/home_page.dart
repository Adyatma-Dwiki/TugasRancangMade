                ...
                Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Welcome Home,",
                            style:
                                TextStyle(fontSize: 20, color: Colors.grey[1000])),
                        Text(
                          displayName,
                                      ...
                                      onChanged: (newValue) {
                                        setState(() {
                                          if (index == 0) {
                                            ...
                                            dbR.update({
                                              'All Devices/Ruangan 1/Light': lampuRuangan1,
                                              'All Devices/Ruangan 1/Door': pintuRuangan1,
                                            });
                                          } else if (index == 1) {
                                            ...
                                            dbR.update({
                                              'All Devices/Ruangan 2/Light': lampuRuangan2,
                                              'All Devices/Ruangan 2/Door': pintuRuangan2,
                                            });
                                          } else if (index == 2) {
                                            ...
                                            dbR.update({
                                              'All Devices/Ruangan 3/Light': lampuRuangan3,
                                              'All Devices/Ruangan 3/Door': pintuRuangan3,
                                            });
                                          } else {
                                            ...
                                            dbR.update({
                                              'All Devices/Ruangan 4/Light': lampuRuangan4,
                                              'All Devices/Ruangan 4/Door': pintuRuangan4,
                                            });
                                          }
                                        });
                                      },
